<?php
	...
	if (isset($_POST['submit1'])){
		...
		setcookie("username", $userInfo, time()+3600*24*7,"/tugas_K3517041");
		//header("Location: action.php");
	}
...
<body>
	...
	<?php
		...
		if ($_SESSION['lives'] == 0){
			...
			$query = "INSERT INTO score (Username, Score, playtime, foto) VALUES ('".$_COOKIE['username
			']."', ".$_SESSION['score'].", '".date('Y-m-d H:i:s')."','".$_SESSION['filenameupload']."')";
